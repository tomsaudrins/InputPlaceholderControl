...
export class AdvancedInput implements ComponentFramework.StandardControl<IInputs, IOutputs> {
	...
	public init(context: ComponentFramework.Context<IInputs>, notifyOutputChanged: () => void, state: ComponentFramework.Dictionary, container:HTMLDivElement): void
	{
		...
		this._inputValue = context.parameters.inputElement.raw || "";
	...
	public updateView(context: ComponentFramework.Context<IInputs>): void
	{
		...
		this._inputValue = context.parameters.inputElement.raw || "";
		this._inputElement.value = this._inputValue;	
		this._inputElement.setAttribute("placeholder", context.parameters.placeholder.raw || "");
	}
